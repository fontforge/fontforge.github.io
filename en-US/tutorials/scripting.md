...
-   [Examples elsewhere](documentation/scripting/native/#Example)
...
FontForge's own additions to Python are documented [here](documentation/scripting/python/).*
...
[File-\>Open](documentation/interface/filemenu/#Open) the font and then
[File-\>Generate](documentation/interface/filemenu/#Generate) a truetype font. You do
...
'[\$1](documentation/scripting/native/#variables)' is magic. It means the [first argument
passed to the script](#Invoking).

'[\$1:r + ".ttf"](documentation/scripting/native/#Expressions)' is even more complicated
...
See the [page on scripting](documentation/scripting/native/#Example).
