...
### Getting source from the cvs tree
...
most recent version of the cvs source tree by typing:
...
You can also [browse the CVS tree](http://fontforge.cvs.sourceforge.net/fontforge/fontforge/)
online. Or see [sourceforge's description](http://sourceforge.net/cvs/?group_id=103338)for more
information, or read the [CVS manual](http://www.cvshome.org/docs/manual/).~~
